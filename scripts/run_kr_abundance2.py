...
def main():
    ...
    parser.add_argument("--top_N", type=int, default=1, help="Select the top N most common viruses or bacteria.")
    ...
    parser.add_argument("--max_read_count", type=10**1000,default=None, help="Maximum number of read counts")
